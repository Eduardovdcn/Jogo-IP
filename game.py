...
class Torre(Boss):
    def andar(self):
        if self.walkCount <= 0: # o Boss anda "2" vezes antes de parar
            distanciaX = Dama.posicao_x - self.bossX # Distancia entre o player e o boss na posição X
            distanciaY = Dama.posicao_y - self.bossY # Distancia entre o player e o boss na posição Y
